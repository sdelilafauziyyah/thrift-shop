                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="addresOne">Adress</label>
                            <input
                              type="text"
                              class="form-control"
                              id="address_one"
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                          <div class="form-group">
                            <label>Bank Name - A/N</label>
                            <input type="text" class="form-control" name="nama_rekening" value="{{ $user->nama_rekening }}" required/>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Rekening Number</label>
                            <input type="text" class="form-control" name="no_rekening" value="{{ $user->no_rekening }}" required/>
                          </div>
                        </div>
                      </div>
                      <div class="row">
