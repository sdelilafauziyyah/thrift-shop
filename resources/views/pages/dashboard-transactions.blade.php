                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                    ...
                                                    <p class='text-warning'>{{ $transaction->shipping_status }}</p>
                                                    @elseif ($transaction->shipping_status == "SUCCESS")
                                                      <p class='text-success'>{{ $transaction->shipping_status }}</p>  
                                                     @elseif ($transaction->shipping_status == "SHIPPING")
                                                      <p class='text-default'>{{ $transaction->shipping_status }}</p>  
                            ...
                            @foreach ($buyTransactions as $transaction)
                                <a
                                    href="{{ route('dashboard-transaction-buy', $transaction->id) }}"
                                    class="card card-list d-block"
                                >
                                    <div class="card-body">
                                        <div class="row">
